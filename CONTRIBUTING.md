...
- Please include the output from `sempliceWatch --dump` for diagnosis
- If there's a script that sempliceWatch is having trouble with or is causing sempliceWatch to throw exceptions, please include it in your filed issue to allow me to replicate the issue.